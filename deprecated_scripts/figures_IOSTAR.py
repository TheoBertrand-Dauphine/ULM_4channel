...
def main(args):
    ...
    validation_dataset = IOSTARDataset(root_dir =  './data_IOSTAR/test_images', transform=transforms.Compose([CenterCrop(32*14), HeatMap(s=9, alpha=3, out_channels = 4), ToTensor(), Padding(0)])) 
    ...
    curves, list_of_stacks, Tcsr_list, prim_dict, labels = Cluster_from_Distance(D, L, distance_threshold = 0.05)
